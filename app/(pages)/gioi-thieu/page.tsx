          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-white/5 p-5 md:p-6 rounded-2xl border border-white/5 hover:border-amber-400/20 transition-all group">
              ...
              <div className="space-y-3">
                <a href="mailto:janencl1125@gmail.com" className="flex items-center gap-2 md:gap-3 text-xs md:text-sm text-white/80 hover:text-amber-400 transition-colors break-all">
