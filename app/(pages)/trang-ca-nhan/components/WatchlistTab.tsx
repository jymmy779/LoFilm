          ...
          {watchlist.map((item) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-3 right-3 p-1.5 bg-black/60 hover:bg-amber-500 rounded-lg transition-all opacity-100 z-30 cursor-pointer border border-white/10"
