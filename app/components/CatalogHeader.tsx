...
export default function CatalogHeader({ title, breadcrumbText }: CatalogHeaderProps) {
    ...
    return (
        <div className="catalog-header-wrapper">
            ...
            <nav className="flex items-center gap-2 mb-6 text-[13px] text-white/50">
                <Link href="/" className="hover:text-white transition-colors flex items-center" aria-label="Trang chủ">
