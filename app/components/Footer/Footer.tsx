                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
                    ...
                    <div className="col-span-1 lg:col-span-8 flex flex-col gap-6">
                        ...
                        <div className="text-[12px] text-white/40 leading-relaxed max-w-4xl space-y-4">
                            <p>
                                <strong className="text-white/60 font-semibold">LoFilm</strong> ra đời với sứ mệnh mang không gian điện ảnh chân thực nhất đến ngay màn hình của bạn. Không chỉ dừng lại ở một nền tảng xem phim trực tuyến, chúng tôi nỗ lực tạo ra một trạm dừng chân giải trí cao cấp, nơi bạn có thể đón xem những siêu phẩm chiếu rạp, phim bộ độc quyền và các TV Show thịnh hành nhất. Với giao diện tối giản chuẩn cinematic, hệ thống điều hướng thông minh cùng tốc độ truyền tải mượt mà, LoFilm định hình lại cách bạn tận hưởng nghệ thuật thứ bảy.
                            </p>
                            <p>
