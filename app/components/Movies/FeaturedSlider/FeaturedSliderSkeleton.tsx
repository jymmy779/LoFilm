    ...
    return (
        <Container as="section" className="relative select-none overflow-hidden">
            ...
            <div className="relative py-2 sm:py-4 flex justify-center items-center gap-4 overflow-hidden">
                <div className="hidden md:block w-1/4 aspect-[16/9] rounded-3xl bg-white/[0.02] border border-white/5 opacity-30 transform scale-90" />
                <div className="w-[82vw] sm:w-[520px] md:w-[640px] lg:w-[760px] xl:w-[860px] aspect-[16/9] sm:aspect-[16/9.2] rounded-3xl bg-[#12151C]/60 border border-white/10 p-6 flex flex-col justify-between">
                    <div className="flex gap-2">
